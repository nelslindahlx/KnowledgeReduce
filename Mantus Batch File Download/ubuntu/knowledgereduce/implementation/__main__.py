...
class KnowledgeReduce:
    ...
    def create_from_url(self, url):
        ...
        Returns:
            KnowledgeReduce: Self for method chaining
        """
    ...
    def merge_with(self, other_framework):
        """
        Merge with another KnowledgeReduce instance.
        
        Args:
            other_framework (KnowledgeReduce): Another framework instance
    ...
    def add_relationship(self, source_id, target_id, relationship_type, weight=1.0, **kwargs):
        """
        ...
        Args:
            ...
            weight (float, optional): Weight of the relationship
            **kwargs: Additional attributes for the relationship
            
        Returns:
            KnowledgeReduce: Self for method chaining
        """
        self.knowledge_graph.add_relationship(
            source_id, target_id, relationship_type, weight=weight, **kwargs
        )
        return self
